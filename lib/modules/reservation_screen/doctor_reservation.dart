...
class ShowDoctorReservation extends StatelessWidget {
                          ...
                          children: <Widget>[
                            BuildCondition(
                              ...
                              builder: (context) =>BuildCondition(
                                ...
                                builder:(context) => ListView.separated(
                                  itemBuilder: (context, index) => showReservation(context, AppCubit.get(context).upcomingReservations[index], index),
                            ...
                            BuildCondition(
                              ...
                              builder: (context) =>BuildCondition(
                                ...
                                builder:(context) => ListView.separated(
                                  itemBuilder: (context, index) => showReservation(context, AppCubit.get(context).completeReservations[index], index),
  ...
  Widget showReservation(
      ...
      FutureBuilder(
          future: AppCubit.get(context).getPatientData(resvModel.patientId!),
          builder: (context, AsyncSnapshot<PatientModel> snap) {
            if (snap.data == null) {
              if (kDebugMode) {
